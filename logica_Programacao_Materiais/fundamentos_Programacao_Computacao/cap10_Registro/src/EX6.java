...
public class EX6 {
	...
	{ Scanner entrada = new Scanner(System.in);
	  Funcionario func[];
	  func = new Funcionario[15];
	  int i, pos_maior=-1, mes=0;
	  float maior, pontos, valor_total;
	
	  System.out.println("\nCADASTRANDO OS FUNCION�RIOS\n");
	  for (i=0;i<15;i++)
	    { func[i] = new Funcionario();
	      entrada = new Scanner(System.in);
	      System.out.print("\nDigite o nome do " + (i+1) + "� funcionario ");
	      func[i].nome = entrada.nextLine();
	      System.out.print("\nDigite o valor vendido no mes de novembro pelo " + (i+1) + "� funcionario ");
	      func[i].venda_nov = entrada.nextFloat();
	      System.out.print("\nDigite o valor vendido no mes de dezembro pelo " + (i+1) + "� funcionario ");
	      func[i].venda_dez = entrada.nextFloat();
	      System.out.print("\nDigite o valor vendido no mes de janeiro pelo " + (i+1) + "� funcionario ");
